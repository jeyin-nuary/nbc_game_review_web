...
router.post("/signup", async(req, res) => {
    const{login_id, password, confirmPassword, nickname, age, email, introduction} =req.body;
    console.log(Users);
    ...
    //사용자 테이블에 데이터 삽입
    const user = await Users.create({login_id,password,nickname, age, email, introduction});
